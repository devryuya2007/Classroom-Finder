...
export const PLACEHOLDER_ACCOUNT_MISMATCH =
  "アカウントを確認してから再試行してください。";
export const PLACEHOLDER_ACCOUNT_SWITCH_SUCCESS =
  "Google Classroom をリロードしてください";
...
export const STREAM_SELECTOR_PRIMARY =
